...
public class HomeworkDao {
	...
	public void insert(Homework homework) {
		String sql = "insert into homework (title, content, finishTime, teacherId)values(?, ?, ?, ?)";
		try {
			DBConnect dbConnect = new DBConnect(sql);
